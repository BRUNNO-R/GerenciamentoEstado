...
export default function Carrinho() {
  ...
  return (
    <div className="containerCart">
      ...
      {/* Título do carrinho */}
      <div style={{ background: "#eee8aa", display: 'flex', justifyContent: 'center', alignItems: 'center', height: '30vh' }}>
      <h2 style={{ fontSize: '2rem', color: 'green' }}>Carrinho - Lista de compras</h2>
      </div>
